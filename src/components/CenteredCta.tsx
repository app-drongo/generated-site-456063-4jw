// Enhanced by AI on 2025-08-12T14:36:41.346Z
// Section: cta
// Category: cta
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of successful teams who have transformed their workflows
                with our powerful collaboration tools. Start your free trial today.
              </p>
