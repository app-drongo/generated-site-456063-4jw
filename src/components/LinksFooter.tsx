// Enhanced by AI on 2025-08-12T14:36:57.972Z
// Section: footer
// Category: footer
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Collaborate is a powerful SaaS platform that helps teams work together more effectively. 
                Join thousands of businesses who trust our tools to boost productivity and streamline workflows.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@collaborate.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">123 Collaboration Ave, Suite 100</span>
              </div>
            </div>
