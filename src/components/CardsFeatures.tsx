// Enhanced by AI on 2025-08-12T14:36:09.427Z
// Section: features
// Category: features
...
export default function CollaborationFeatures() {
  const features = [
    ...
    },
    {
      ...
      description: "Intuitive interface that works seamlessly across all devices and screen sizes.",
      badge: "Design"
    },
    {
      icon: Globe,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Powerful features designed to help your team work together more efficiently
